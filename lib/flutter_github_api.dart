...
Future<GithubAuthEntity> getAuthorization(Auth auth, Account account) async {
...
/// login
Future<User> login(Auth auth, Account account) async {
...
BaseOptions _getOptions(Account account) {
